...
< type="text/javascript" src="../../resources/js/common/jquery.js"></script>

<!-- custom javascript -->
<script type="text/javascript"
   src="../../resources/js/mainBody/mainList.js"></script>
<script src="../../resources/js/project/projectReporting.js"></script>
      ...
      <div class="container">
               ...
               <div class="row" style="align-items: center;">
                  <div class="col-md-11">
                     ...
                     <div class='col-sm-6 col-lg-6 col-md-6'>
                        ...
                        <div class='thumbnail'>
                           <a href="/dreamUp/projectInfoView.do?project_No=1"> <img
                           ...
                           <div class='caption'>
                              ...
                              <p>함께 나누고 싶은 소중한 추억을, 감사한 이에게 전하고 싶은 따뜻한 마음을, 레드만의 차별화된
                                 카드/엽서로 표현해 보세요.</p>
                     ...
                     <div class='col-sm-6 col-lg-6 col-md-6'>
                        <div class='thumbnail'>
                           <a href="/dreamUp/projectInfoView.do?project_No=2"> <img
               ...
               <div class="row">
                  <div class="col-sm-12" align="left">
                     ...
                     <div class='col-sm-4 col-lg-4 col-md-4'>
                        <div class='thumbnail'>
                           <a href="/dreamUp/projectInfoView.do?project_No=3"> <img
                     ...
                     <div class='col-sm-4 col-lg-4 col-md-4'>
                        <div class='thumbnail'>
                           <a href='/dreamUp/projectInfoView.do'> <img
                           ...
                           <div class='caption'>
                              ...
                              <p>익스커션은 크고, 왜곡은 적은 맞춤 제작 드라이버가 파워풀한 베이스를 들려주고 놀랍도록 깨끗하고
                                 순수한 사운드를 뽑아냅니다.</p>
                              <p style="color: gray;">제품</p>
                              <div class="point" style="font-size: large">
                                 <div class='col-md-4' align='center'>
                     ...
                     <div class='col-sm-4 col-lg-4 col-md-4'>
                        <div class='thumbnail'>
                           <a href='#'> <img src='../../resources/img/tempImg03.jpg'></a>
                           ...
                           <div class='caption'>
                              ...
                              <p>실리콘밸리 '방탄커피로 당을 끊고 군것질을 줄여보세요 ! 키토제닉 식단의 필수품 『마이노멀
                                 버터커피』를 소개합니다.</p>
                              <p style="color: gray;">음식</p>
                              <div class="point" style="font-size: large">
                                 <div class='col-md-4' align='center'>
         ...
         <div class="row">
            <div class="col-sm-12" align="left">
               ...
               <div class='col-sm-4 col-lg-4 col-md-4'>
                  <div class='thumbnail'>
                     <a href='#'> <img src='../../resources/img/tempImg04.jpg'></a>
                     ...
                     <div class='caption'>
                        ...
                        <p>실내에 있는 시간이 길어지는 요즘, 나만의 공간에서 손쉽게 꾸리는 귀여운 정원! 다육이 한번
                           길러보시겠어요? 다육이는 큰 것보다 작은게 더 튼튼하고 관리도 쉽다는 사실!</p>
                        <p style="color: gray;">디자인</p>
                        <div class="point" style="font-size: large">
                           <div class='col-md-4' align='center'>
                              <b>60%</b><br /> <small>달성도</small>
               ...
               <div class='col-sm-4 col-lg-4 col-md-4'>
                  <div class='thumbnail'>
                     <a href='#'> <img src='../../resources/img/tempImg05.jpg'></a>
                     ...
                     <div class='caption'>
                        ...
                        <p>딸기가 살아있는듯 남다른 과육, 정성이 듬뿍 담긴 리얼 수제 딸기레몬청으로 온 가족들과 함께 홈카페를
                           즐겨 보세요</p>
                        <br>
               ...
               <div class='col-sm-4 col-lg-4 col-md-4'>
                  <div class='thumbnail'>
                     <a href='#'> <img src='../../resources/img/tempImg06.jpg'></a>
