...
<head>
<!-- Bootstrap Core CSS -->
<link href="/web/toyProject/DreamUp_View/resources/css/bootstrap.min.css" rel="stylesheet">

<!-- --------------------------- Custom CSS --------------------------- -->
<!-- Custom CSS -->
<link href="/web/toyProject/DreamUp_View/resources/css/shop-homepage.css" rel="stylesheet">
<link href="/web/toyProject/DreamUp_View/resources/css/common/commonStyle.css" rel="stylesheet">

<link href="/web/toyProject/DreamUp_View/resources/css/custom/index.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="/web/toyProject/DreamUp_View/resources/css/member/findView.css">

<!-- Dream Up Login.css -->
<link href="/web/toyProject/DreamUp_View/resources/css/common/login.css" rel="stylesheet"type="text/css" />

<!-- jQuery -->
<script src="/web/toyProject/DreamUp_View/resources/js/common/jquery.js"></script>

<!-- Bootstrap Core JavaScript -->
<script src="/web/toyProject/DreamUp_View/resources/js/common/bootstrap.min.js"></script>
...
<!-- --------------------------- Custom javascript --------------------------- -->
<!-- header.js -->
<script type="text/javascript" src="/web/toyProject/DreamUp_View/resources/js/header/header.js"></script>
<!-- login.js -->
<script type="text/javascript" src="/web/toyProject/DreamUp_View/resources/js/login/login.js"></script>
...
<!-- 			<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
				...
				<a class="navbar-brand" href="/web/toyProject/DreamUp_View/views/mainView/mainBody.jsp">
				<img src="/web/toyProject/DreamUp_View/resources/img/logo_renew.png" width="150"></a> 
		</div>
	
		<!-- Collect the nav links, forms, and other content for toggling -->
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li><a id="main_category" href="/web/toyProject/DreamUp_View/views/mainView/category_project_list.jsp">카테고리별 프로젝트</a></li>
					<li><a id="projectRegiterView" href="/web/toyProject/DreamUp_View/views/project/register/projectBasicInfoView.jsp">프로젝트 등록</a></li>
				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						...
						<!-- 		<div class="social-login">
								...
								<a href="../member/joinForm.jsp" class="btn btn-success btn-block" role="button">회원가입</a>
...
<script type="text/javascript" src="/web/toyProject/DreamUp_View/resources/js/header/project_search.js"></script>
