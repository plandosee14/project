...
//			var reward_title = $("#reward_title").val()
	...
	function next() {
		document.location.href="/web/toyProject/DreamUp_View/views/project/register/projectStoryView.jsp";
	}
</script>
<article>
	...
	<div class="container">
		<div class="col col-md-12"">
			...
			<!-- 	<a id="addRewardBox">추가</button> -->
				<button type="button" id="rewardInfoRegister" class="btn btn-primary pull-right" onclick="next()">저장하고 다음으로</button>
			</div>
			<div class="col col-md-2"></div>
		</div>
	</div>
